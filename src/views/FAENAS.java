...
public class FAENAS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNombre.setEditable(false); // solo mostrar nombre
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Thread(() -> {
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                // Año de nacimiento y generación de la tabla de meses
                if (u.getFechaNacimiento() != null) {
                    ...
                    Double pagado = 0.0; // luego traerás el monto pagado desde la BD
    ...
    private javax.swing.JLabel jLabel7; // NUEVO
    ...
    private javax.swing.JTextField txtNombre;  // NUEVO
